...
def two_hidden_layers_original(x):
...
# logits1 = two_hidden_layers_original(x1)
# logits2 = two_hidden_layers_original(x2)
...
writer = tf.summary.FileWriter('./graphs/cool_variables_3', tf.get_default_graph())
writer.close()